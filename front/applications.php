  ...
  <div class="container">
    <header>
      ...
      <nav>
        ...
        <a data-aos="fade-down" data-aos-duration="2000" href="applications.php" class="active">APPLICATIONS</a>
    ...
    <main>
      <div class="page-content">
        <h2 data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-offset="0" data-aos-duration="1500">APPLICATIONS</h2>
        <p data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-offset="0" data-aos-duration="2000">
          Teknologi AI telah digunakan di berbagai sektor untuk meningkatkan efisiensi dan inovasi, Contohnya:
        </p>

        <div data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-offset="0" data-aos-duration="2500" class="cards">
          <div class="card">🧠 <strong>ChatGPT</strong><br>• Membantu membuat teks, ide & Cepat untuk belajar dan tugas</div>
          <div class="card">🤖 <strong>Claude</strong><br>• Memberi jawaban rapi, jelas & Kuat untuk analisis dokumen</div>
          <div class="card">🎨 <strong>Recraft</strong><br>• Membuat gambar, ilustrasi & Praktis untuk kebutuhan desain</div>
        </div>
      </div>
    </main>
