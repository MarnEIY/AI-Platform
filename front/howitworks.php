...
<body>
  ...
  <div class="container">
    <header>
      ...
      <nav>
        <a data-aos="fade-down" data-aos-duration="1500" href="howitworks.php" class="active">HOW IT WORKS</a>
    ...
    <main>
      <div class="page-content">
        <h2 data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-offset="0" data-aos-duration="1500">HOW IT WORKS</h2>
        <p data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-offset="0" data-aos-duration="2000">
          Kecerdasan buatan bekerja dengan meniru pola pikir manusia melalui data, algoritma, dan pembelajaran mesin.
          Sistem AI menganalisis data besar, mengenali pola, lalu membuat keputusan atau prediksi secara otomatis.
        </p>

        <div data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-offset="0" data-aos-duration="2500" class="workflow">
          <div class="step">Data</div>
          <div class="arrow">→</div>
          <div class="step">Algorithm</div>
          <div class="arrow">→</div>
